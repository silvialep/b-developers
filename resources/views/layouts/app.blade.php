...
<body>
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm nav-bar-cont">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item d-flex">
                            <a class="nav-link" style="color:rgb(20, 110, 190); font-weight:bold" href="{{url('/') }}">{{ __('Home') }}</a>
