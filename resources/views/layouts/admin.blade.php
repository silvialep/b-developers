        ...
        <nav class="nav-bar-cont">
            <div class="container nav-container">
                ...
                <div class="nav-burger">
                    <div class="dropdown">
                        <button class="btn btn-outline-light" type="button" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fa-solid fa-bars"></i>
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                            <li><a class="dropdown-item text-dark" style="font-weight:bold" href="{{url('http://localhost:5174/') }}">{{ __('Home') }}</a></li>
                ...
                <div class="nav-links">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item d-flex gap-3">
                            <a class="nav-link text-white" style="font-weight:bold" href="http://localhost:5174/">{{ __('Home') }}</a>
