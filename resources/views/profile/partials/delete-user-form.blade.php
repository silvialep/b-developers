<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            ...
            {{ __('Una volta cancellato, tutte le informazioni saranno perse. Prima di cancellare il tuo account, scarica tutte le informazioni che vorresti mantenere.') }}
        </p>
    </header>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        ...
                        {{ __('Una volta cancellato, tutte le informazioni saranno perse. Per favore, reinserisci la tua password per confermare la volontà di cancellare definitivamente il tuo account.') }}
                    </p>
                </div>
